...
module sonar::economics {
    ...
    public fun default_config(): EconomicConfig {
        EconomicConfig {
            ...
            tier_1_floor: 50_000_000_000_000_000,   // 50M SONAR
            tier_2_floor: 35_000_000_000_000_000,   // 35M SONAR
            tier_3_floor: 20_000_000_000_000_000,   // 20M SONAR

            // Burn rates (basis points)
            tier_1_burn_bps: 6000,                  // 60%
            tier_2_burn_bps: 4500,                  // 45%
            tier_3_burn_bps: 3000,                  // 30%
            tier_4_burn_bps: 2000,                  // 20%

            // Liquidity rates (basis points)
